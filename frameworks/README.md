...
| [vendor-question-bank.md](vendor-question-bank.md) | 7 | Thirty neutral questions across identity, determinism, memory, economics, evaluation and exit, each with what a good answer contains and what a bad answer sounds like |
| [vendor-scorecard.md](vendor-scorecard.md) | 7 | Disqualifiers first, scores second, weighted by use case; the output is a profile, not a total |
