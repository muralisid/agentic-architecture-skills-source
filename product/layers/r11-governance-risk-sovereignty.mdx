...
Follow the proposed [compliance evidence](/use-cases/compliance-evidence) example. Compare the required capability with the systems already in place, then use the [architecture map](/architecture) to inspect neighboring responsibilities.
