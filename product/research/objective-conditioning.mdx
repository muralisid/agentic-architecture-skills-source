...
- Promptriever (ICLR 2025), INSTRUCTOR (ACL Findings 2023), GSTransform (2025), CAMI (2026) and TnT-LLM (KDD 2024), the prior art that subsumes this idea, on the [reading list](/research/reading-list).
- [How the programme was run](/research/method-and-reversals) for the preregistration, its waiver, and the cross-machine replication.
