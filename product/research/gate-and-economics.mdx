...
- TnT-LLM (KDD 2024), Databricks (Jul 2026, vendor) and Distilling Step-by-Step (ACL Findings 2023) for the published economics of letting a model design and classical machinery execute, on the [reading list](/research/reading-list).
