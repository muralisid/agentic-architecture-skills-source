...
<ResultChart
  ...
  source="Benchmark repository, results/e1_scifact_matched/metrics.json and results/e1_llm_taxonomy_scifact/metrics.json, commit 92c18cb (2026-08-22). Byte-identical on a second machine for the hand-written taxonomy; −0.044 against chunks (p=0.004) on the second machine for the model-designed one."
/>
...
- [The recommended approach](/research/recommended-approach) for how this boundary becomes a decision rule.
