...
<TeachingIllustration src="/images/use-cases/compliance-evidence-v1.webp" expandable title="Collect and check compliance evidence" alt="Keep the requirement and version, map shared checks without losing obligations, collect departmental evidence, validate scope and dates, and prepare gaps for a reviewer." caption="Proposed agent extension. Each action remains within an explicitly permitted business process." />
