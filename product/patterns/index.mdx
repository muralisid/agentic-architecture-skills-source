...
These patterns are the part of an agent system that a coordination platform does not supply. [What an Agentic OS is, and what it does not solve](/architecture/agentic-os) sets out why.
