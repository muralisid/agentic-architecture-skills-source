...
<ResultChart
  ...
  source="Benchmark repository, results/e0_dilution/metrics.json and results/e1_anchor_sensitivity/metrics.json, commit 2b9c6ef (2026-08-22). Reproduced on a second machine to within 5e-8."
/>
...
<ResultChart
  ...
  source="Benchmark repository, results/e1_limit/metrics.json, commit 2b9c6ef (2026-08-22). Byte-identical on a second machine."
/>
