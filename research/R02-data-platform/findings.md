---
reader_summary: "Use the evidence, target state, sequencing, economics, and open gaps for the data platform to make architecture decisions."
audience: ["CIO/CTO","Enterprise architect","Data platform lead"]
decision_or_output: "Record the target-state posture, sequencing priority, and unresolved risk for the data platform."
prerequisites: ["/docs/layers/r02-data-platform/brief"]
...
next: "/docs/layers/r02-data-platform/vendors"
---
