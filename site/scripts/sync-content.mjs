...
const metas = {
  ...
  security: {
    ...
    icon: 'ShieldCheck',
    description: 'Threat modelling, adversarial evaluation, runtime controls and incident practices for AI agents.',
  ...
  memory: {
    ...
    icon: 'Brain',
    description: 'Remember the work, preserve evidence, and improve future decisions.',
    pages: [
      'index',
      '---Start with the foundations---',
      'memory-types', 'information-to-memory',
      '---Make memory usable---',
      'choosing-representations', 'images-video-and-audio', 'combining-evidence',
      'changing-facts', 'permissions-and-lifecycle', 'what-the-benchmarks-measure',
      '---Optional visual tour---',
      'vector-spaces',
      '---Advanced design and research---',
      'six-architectures', 'long-context-is-not-memory',
      'the-ten-million-token-question', 'what-we-have-measured', 'sources',
    ],
  },
  library: {
    title: 'Research library',
