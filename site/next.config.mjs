...
const config = {
  ...
  async redirects() {
    return [
      ...
      { source: '/research/aspect-dilution', destination: '/patterns/aspect-dilution', permanent: false },
      { source: '/research/real-prose', destination: '/patterns/real-prose', permanent: false },
      { source: '/research/gate-and-economics', destination: '/patterns/gate-and-economics', permanent: false },
      { source: '/research/diversity-and-consumer', destination: '/patterns/diversity-and-consumer', permanent: false },
      { source: '/research/how-to-test-a-context-design', destination: '/patterns/how-to-test-a-context-design', permanent: false },
      { source: '/research/what-we-got-wrong', destination: '/patterns/what-we-got-wrong', permanent: false },
      { source: '/research/reading-list', destination: '/patterns/reading-list', permanent: false },
      { source: '/research/why-not-to-condition-on-the-objective', destination: '/patterns/why-not-to-condition-on-the-objective', permanent: false },
