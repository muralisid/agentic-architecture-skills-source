...
const foundationalFigures: FigureManifestEntry[] = [
  ...
  defineFigure({
    id: 'model-change-diagnosis', category: 'foundation', page: '/ladder', placement: 'Deck B', sourceHeading: 'Deck B: change the model',
    title: 'Deck B: choose by symptom, not by ambition',
